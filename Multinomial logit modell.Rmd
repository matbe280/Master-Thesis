...
# I do this since they represent parties that i do not want to include in the analysis. 
data <- data %>% 
...
for (year in 2008:2021) {
  ...
  # Append the year, log-likelihood, and AIC to the dataframe
...
for (year in 2008:2021) {
  ...
  # Append the year, log-likelihood, AIC, and accuracy to the dataframe
